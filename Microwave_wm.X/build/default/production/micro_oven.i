...
void display_power_screen(void){
    ...
    clcd_print("Powering ON",(0xC0 + 3));

    clcd_print("Microwave Oven",(0x90 + 2));
...
void display_modes(void){
    clcd_print("1. Micro",(0x80 + 1));
    clcd_print("2. Grill",(0xC0 + 1));
    clcd_print("3. Convection",(0x90 + 1));
    clcd_print("4. Start",(0xD0 + 1));
}
void set_time(unsigned char key,unsigned char reset_flag){
    ...
    if(display_blank){
        ...
        clcd_putch( sec / 10 + '0',(0xC0 + 8));
        clcd_putch( sec % 10 + '0',(0xC0 + 9));
        clcd_putch( min / 10 + '0',(0xC0 + 5));
...
void display_time(void){
    clcd_print("TIME =  ",(0x80 + 1));
    clcd_putch( min / 10 + '0',(0x80 + 9));
    clcd_putch( min % 10 + '0',(0x80 + 10));
    clcd_putch(':',(0x80 + 11));
    clcd_putch( sec / 10 + '0',(0x80 + 12));
    clcd_putch( sec % 10 + '0',(0x80 + 13));
    clcd_print("4.START/RESUME",(0xC0 + 2));
    clcd_print("5.PAUSE",(0x90 + 2));
    clcd_print("6.STOP",(0xD0 + 2));

    if(min == 0 && sec == 0){
        clear_screen();
        TMR2ON = 0;
        RC2 = 0;
        clcd_print("TIME UP!!!",(0xC0 + 4));
        clcd_print("ENJOY YOUR MEAL",(0x90 + 0));
...
void set_temp(unsigned char key,unsigned char reset_flag){
    ...
    if(key != '*' && key != '#' && key != 0xFF){
        ...
        TMR2ON =1;
        clcd_print("Pre-Heating",(0x80 + 3));
        clcd_print("Time Rem:",(0x90 + 0));
        clcd_putch('s',(0x90 + 12));
        while(pre_heat){
        clcd_putch(pre_heat / 100 + '0',(0x90 + 9));
        clcd_putch((pre_heat/10) % 10 + '0',(0x90 + 10));
        clcd_putch((pre_heat % 10) + '0',(0x90 + 11));
        }
    ...
    if(display_blank){
        ...
        clcd_putch(temp / 100 + '0',(0xC0 + 7));
        clcd_putch((temp/10) % 10 + '0',(0xC0 + 8));
        clcd_putch((temp % 10) + '0',(0xC0 + 9));
